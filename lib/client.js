...
const OPENAI_API_KEY = process.env.OPENAI_API_KEY || 'votre_clé_openai';
const BOT_NUMBER = process.env.BOT_NUMBER || 'votre_numero';
const BLOCKED_JID = process.env.BLOCKED_JID || 'jid_bloqué@s.whatsapp.net';
const MEDIA_LINK = process.env.MEDIA_LINK || 'lien_vers_image_ou_video';
...
console.log(`Nom: ${bio.name}`);
console.log(`Âge: ${bio.age}`);
console.log(`Localisation: ${bio.location}`);
