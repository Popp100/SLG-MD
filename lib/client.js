...
let cc= name.sessionName.replace(/SLG-MD;;;/g, "");
var Zubair = false;
...
setTimeout(() => {
    ...
    global.slogo = 'https://telegra.ph/file/93a48e3348250cc741a6d.jpg'
    global.sgc = 'https://whatsapp.com/channel/0029VaWQOHsFSAsv3SD3dJ3a'
    global.srepo = 'https://github.com/GEEKMDXINC/SLG-MD'
    global.scap = '*⤹★ᴘᴏᴡᴇʀᴇᴅ ʙʏ★⤸ SLG ᴹᴰ* '
...
<html>
  ...
  <body>
    <section>
      Hello from "GEEK TECH"!
    </section>
  </body>
</html>
`
app.get("/", (req, res) => res.type('html').send(html));
app.listen(port, () => console.log(`SLG-MD Server listening on port http://localhost:${port}!`));
